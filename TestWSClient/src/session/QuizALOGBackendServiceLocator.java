...
public class QuizALOGBackendServiceLocator extends org.apache.axis.client.Service implements session.QuizALOGBackendService {
    ...
    public session.QuizALOGBackend getQuizALOGBackendPort() throws javax.xml.rpc.ServiceException {
    ...
    public session.QuizALOGBackend getQuizALOGBackendPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            session.QuizALOGBackendPortBindingStub _stub = new session.QuizALOGBackendPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (session.QuizALOGBackend.class.isAssignableFrom(serviceEndpointInterface)) {
                session.QuizALOGBackendPortBindingStub _stub = new session.QuizALOGBackendPortBindingStub(new java.net.URL(QuizALOGBackendPort_address), this);
                _stub.setPortName(getQuizALOGBackendPortWSDDServiceName());
                return _stub;
            }
        }
