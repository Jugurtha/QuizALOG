...
public class Question  implements java.io.Serializable {
    private session.Answer[] answers;
     ...
     * @return answers
     */
    public session.Answer[] getAnswers() {
        return answers;
    }
     ...
     * @param answers
     */
    public void setAnswers(session.Answer[] answers) {
        this.answers = answers;
    }

    public session.Answer getAnswers(int i) {
        return this.answers[i];
    }

    public void setAnswers(int i, session.Answer _value) {
